...
OBJS = ex2.o initial_condition.o

ex2: ${OBJS} chkopts
	-${CLINKER} -o ex2 ${OBJS} ${PETSC_KSP_LIB}
	${RM} ${OBJS}
ex3.o: ex3.cpp
...
mystruct.o: mystruct.cpp mystruct.hpp
OBJS3 = ex3.o initial_cond.o mesh_gen.o Legendre_Gauss_Lobatto.o
