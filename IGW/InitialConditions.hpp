...
public:
	...
	virtual double getR(const PointPhysicalT& pPhys, double t)const=0;
    virtual double getP(const PointPhysicalT& pPhys, double t)const=0;
	virtual double getrho0(const PointPhysicalT& pPhys, double t)const=0;
	virtual double getrho0Deriv(const PointPhysicalT& pPhys, double t)const=0;
	virtual double getN2(const PointPhysicalT& pPhys, double t)const=0;
        
};

class EB2DSingleMode: public ExactSolutionBase
{
...
public:
	...
	double getR(const PointPhysicalT& pPhys, double t)const;
    double getP(const PointPhysicalT& pPhys, double t)const;
	double getrho0(const PointPhysicalT& pPhys, double t)const;
	double getrho0Deriv(const PointPhysicalT& pPhys, double t)const;
	double getN2(const PointPhysicalT& pPhys, double t)const;
...
class EBsemiellipse11mode: public ExactSolutionBase
{
...
class EBbucketb: public ExactSolutionBase
{
...
class EBbucketd: public ExactSolutionBase
{
...
class EBbuckete: public ExactSolutionBase
{
...
class EBTrapezoidWAtau3Over2: public ExactSolutionBase
{
    
public:
    EBTrapezoidWAtau3Over2();
...
class WA2D: public ExactSolutionBase
{
...
class IGW2D: public ExactSolutionBase
{
public:
    IGW2D();
...
class IGW2Dprolonged: public ExactSolutionBase
{
public:
    IGW2Dprolonged();
...
class IGWN2LinearAiry: public ExactSolutionBase
{
public:
    IGWN2LinearAiry();
...
class EBSingleMode: public ExactSolutionBase
{
...
class RE0: public ExactSolutionBase
{
public:
    RE0();
...
class RES0: public ExactSolutionBase
{
public:
    RES0();
...
class RES1: public ExactSolutionBase
{
public:
    RES1();
...
class RES2: public ExactSolutionBase
{
public:
    RES2();
...
class RESDO0: public ExactSolutionBase
{
public:
    RESDO0();
...
class REMTC0: public ExactSolutionBase
{
public:
    REMTC0();
...
class CS1D: public ExactSolutionBase
{
public:
    CS1D();
...
class RES02D: public ExactSolutionBase
{
public:
    RES02D();
...
class CS2D: public ExactSolutionBase
{
public:
    CS2D();
...
class CS3D: public ExactSolutionBase
{
public:
    CS3D();
...
class Lambd3DMixed: public ExactSolutionBase
{
public:
    Lambd3DMixed();
...
class ICS2D: public ExactSolutionBase
{
public:
    ICS2D();
...
class InitCondR: public InitCond,public Integration::ElementIntegrandBase<LinearAlgebra::NumericalVector>
{
	public:
  
		InitCondR(const ExactSolutionBase* init);
...
class InitCondP: public InitCond,public Integration::ElementIntegrandBase<LinearAlgebra::NumericalVector>
{
	public:
  
		InitCondP(const ExactSolutionBase* init);
