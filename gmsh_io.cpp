...
//  Parameters:
//
//    Input, std::string GMSH_FILENAME, the GMSH filename.
//
...
void gmsh_mesh1d_write ( std::string gmsh_filename, int m, int node_num,
  double node_x[], int element_order, int element_num, int element_node[] )
...
//  Parameters:
//
//    Input, std::string GMSH_FILENAME, the name of the Gmsh file.
//
...
void gmsh_mesh2d_write ( std::string gmsh_filename, int m, int node_num,
  double node_x[], int element_order, int element_num, int element_node[] )
...
void gmsh_mesh3d_write ( std::string gmsh_filename, int m, int node_num,
  double node_x[], int element_order, int element_num, int element_node[] )
...
//
//    Input, std::string TITLE, a title to be printed.
//
{
...
//  Purpose:
//
//    S_BEGIN reports whether std::string 1 begins with std::string 2, ignoring case.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license.
...
//  Parameters:
//
//    Input, std::string S1, std::string S2, two std::strings.
//
...
//  Purpose:
//
//    S_TO_I4 reads an I4 from a std::string.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license.
...
//  Parameters:
//
//    Input, std::string S, a std::string to be examined.
//
//    Output, int &LAST, the last character of S used to make IVAL.
//
//    Output, bool &ERROR is TRUE if an error occurred.
//
//    Output, int *S_TO_I4, the integer value read from the std::string.
//    If the std::string is blank, then IVAL will be returned 0.
//
{
  char c;
  int i;
...
//
//  If we read all the characters in the std::string, see if we're OK.
//
  if ( istate == 2 )
  {
    ival = isgn * ival;
...
//  Purpose:
//
//    S_TO_R8 reads an R8 from a std::string.
//
//  Discussion:
//
//    This routine will read as many characters as possible until it reaches
//    the end of the std::string, or encounters a character which cannot be
...
//  Parameters:
//
//    Input, std::string S, the std::string containing the
//    data to be read.  Reading will begin at position 1 and
//    terminate at the end of the std::string, or when no more
//    characters can be read to form a legal real.  Blanks,
//    commas, or other nonnumeric data will, in particular,
//    cause the conversion to halt.
//
//    Output, int &LCHAR, the number of characters read from
//    the std::string to form the number, including any terminating
//    characters such as a trailing comma or blanks.
//
//    Output, bool &ERROR, is true if an error occurred.
//
//    Output, double S_TO_R8, the real value that was read from the std::string.
//
{
  char c;
  int ihave;
